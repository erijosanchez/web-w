...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/backend/assets/css/cs-skin-elastic.css') }}">
...
<body>
    ...
    <!-- ALERTAS -->
    <div id="alert-container" class="fixed top-4 right-4 flex flex-col gap-2 alttt">
        @if (session('success'))
            <div
                class="alert-message flex w-full max-w-sm overflow-hidden bg-white rounded-lg shadow-md dark:bg-gray-800">
    ...
    <script src="{{ asset('assets/backend/assets/js/init/weather-init.js') }}"></script>

    <script src="https://cdn.jsdelivr.net/npm/moment@2.22.2/moment.min.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/fullcalendar@3.9.0/dist/fullcalendar.min.js"></script>
    <script src="{{ asset('assets/backend/assets/js/init/fullcalendar-init.js') }}"></script>
